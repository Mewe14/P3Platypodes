...
questions = [
    Question(1, "What kind of place do you want to live in?",
    ...
    Question(3, "Private or public school?",
             [Answer(1, "Public"),
              Answer(2, "Private"),
              Answer(3, "No Preference")]),
    Question(4, "What majors are you considering?",
             [Answer(1, "STEM"),
